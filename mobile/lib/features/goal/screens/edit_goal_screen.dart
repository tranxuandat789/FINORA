        ...
        child: Stack(
          children: [
            Container(
              ...
              child: (!_useImage || (_useImage && _selectedImageFile == null))
                  ? GoalIconMapper.buildGoalIcon(_selectedIcon, size: 40, color: isDark ? const Color(0xFF60A5FA) : const Color(0xFF246BFD))
                  : null,
            ),
            Positioned(
              right: 0, bottom: 0,
